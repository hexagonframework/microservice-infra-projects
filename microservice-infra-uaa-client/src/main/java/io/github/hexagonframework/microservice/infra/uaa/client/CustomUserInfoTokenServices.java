...
/**
 * 自定义UserInfoTokenServices，使用accessToken加载包含UsrPrincipal的认证信息，加载失败返回CustomInvalidTokenException{@link CustomInvalidTokenException}
 * {@link UserInfoTokenServices}.
 *
 * @author Xuegui Yuan
 */
public class CustomUserInfoTokenServices implements ResourceServerTokenServices {
  ...
  public OAuth2Authentication loadAuthentication(String accessToken)
    ...
    if (map.containsKey("error")) {
      ...
      throw new CustomInvalidTokenException(accessToken);
    }
